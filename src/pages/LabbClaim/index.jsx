...
const LabbClaim = () => {
    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="mt-14">
          ...
          <p className="text-2xl sm:text-3xl lg:text-4xl xl:text-6xl text-white font-medium">
            OFFICIAL
          </p>
          <p className="text-2xl sm:text-3xl lg:text-4xl xl:text-6xl text-white font-medium">
            LABB TOKEN
          ...
          <div className="md:pr-24">
            ...
            <div class="h-0 border-t-2 border-white my-5"></div>
            <p className="text-3x1">
        ...
        <ClaimBox ixBackground={true}>
          ...
          <div className="mt-5">
            ...
            <div className="mt-1 relative">
              <button
                style={{ height: "50px" }}
                type="button"
                className="flex justify-between items-center w-full  bg-black border border-gray-300 rounded-md shadow-sm px-3 py-2 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
          ...
          >
            <button className=" bg-black text-amber-500 border-solid border-white border hover:bg-yellow-600 hover:text-black rounded-full transition duration-300 ease-in-out my-10 px-8 py-2">
  ...
  const MoreInfo = () => {
    return (
      <div>
        <div className=" text-white mx-12 sm:mx-16 md:mx-28 lg:mx-60 py-32">
          <div className="text-center text-3xl font-medium ">
            Having Difficulties or Would Like More Information?
          </div>
